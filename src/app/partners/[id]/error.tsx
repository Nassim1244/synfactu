// The `/partners/[id]` route's error boundary, catching a failure of the
...
/**
 * Renders the partner detail page's error fallback: an Alert with a
    ...
    <main className="flex flex-1 flex-col gap-6 p-6">
      <Alert variant="destructive">
        <AlertDescription className="flex items-center justify-between gap-4">
          <span>This partner could not be loaded.</span>
